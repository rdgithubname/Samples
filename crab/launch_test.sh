...
# Summer16 miniAODv3
python launch.py --config nano_mc_94X_Summer16_miniAODv3        --dryrun --production_label legacy_nano_v1 --remoteDir legacy_nano_v1 --unitsPerJob 2 --publish --module Summer16_miniAODv3 --sample DYJetsToLL_M50_LO_S16_94X_ext1
# Fall17 miniAODv2
python launch.py --config nano_mc_94X_Fall17_miniAODv2          --dryrun --production_label legacy_nano_v1 --remoteDir legacy_nano_v1 --unitsPerJob 2 --publish --module Fall17_miniAODv2   --sample DYJetsToLL_M10to50_HT100to200_NLO_F17_94X
# Autumn18 miniAODvconfig
python launch.py --config nano_mc_102X_Autumn18_miniAODv1       --dryrun --production_label legacy_nano_v1 --remoteDir legacy_nano_v1 --unitsPerJob 2 --publish --module Autumn18_miniAODv1 --sample DYJetsToLL_M50_LO_A18_102X
# Run2016
