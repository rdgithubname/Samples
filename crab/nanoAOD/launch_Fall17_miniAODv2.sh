...
python launch.py $@ --config nano_mc_94X_Fall17_miniAODv2  --production_label legacy_nano_v6 --remoteDir legacy_nano_v6 --unitsPerJob 1 --publish --module Fall17_miniAODv2   --sample DM
