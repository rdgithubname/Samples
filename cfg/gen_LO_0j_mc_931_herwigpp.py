...
# with command line options: Configuration/GenProduction/python/herwigppFragment_LO_0j.py --datatier GEN --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN --era Run2_2017 --python_filename gen_LO_0j_mc_931_herwigpp.py --no_exec -n 10
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('herwigppFragment_LO_0j_py_LHE_GEN.root'),
