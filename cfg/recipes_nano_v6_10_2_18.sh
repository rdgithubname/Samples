...
cmsDriver.py nano_v6_mc_10218_Summer16 -s NANO --mc --eventcontent NANOAODSIM --datatier NANOAODSIM  -n 100 --no_exec  --conditions 102X_mcRun2_asymptotic_v7 --era  Run2_2016,run2_nanoAOD_94X2016 --filein /store/mc/RunIISummer16MiniAODv3/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/MINIAODSIM/PUMoriond17_94X_mcRun2_asymptotic_v3_ext2-v1/100000/FA3C5CA2-BDC2-E811-9518-B496910A0290.root --customise_commands="process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)))"
