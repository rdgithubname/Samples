...
## sum up
allSamples = DY + DY_HT + ST_4f + ST_5f + TTJets_HT + TTJets + TTX + TTVV + WJets + WJetsToLNu_HT + WJetsNJetBinned + ZJetsToNuNu_HT + diboson + multiboson + gluglu + QCD + GJetsHT + T2tt_FullSim + ttH
