...
#ZGToLLG_LO_F17_private = FWLiteSample.fromDPMDirectory("ZGToLLG_LO_F17_private",      "/dpm/oeaw.ac.at/home/cms/store/user/llechner/miniAOD/RunIIFall17_privProd_miniAODv2/ZAToLLA0123j_5f_LO_MLM/",   dbFile=dbFile, overwrite=ov, prefix=redirector, skipCheck=True)

VGamma = [
#    ZGToLLG_LO_F17_private,
]
